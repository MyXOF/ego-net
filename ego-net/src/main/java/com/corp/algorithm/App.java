...
//	JavaSparkContext context = new JavaSparkContext(new SparkConf().setAppName("ego-net").set("spark.executor.memory", "4096m"));
//	JavaRDD<String> textFile = context.textFile("hdfs://192.168.130.15:9000/user/hadoop/xuyi/test.txt");
//
